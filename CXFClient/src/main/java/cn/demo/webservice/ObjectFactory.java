 ...
 * generated in the cn.demo.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Query_QNAME = new QName("http://webService.demo.cn/", "query");
    private final static QName _QueryResponse_QNAME = new QName("http://webService.demo.cn/", "queryResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.demo.webservice
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webService.demo.cn/", name = "query")
     ...
     */
    @XmlElementDecl(namespace = "http://webService.demo.cn/", name = "queryResponse")
